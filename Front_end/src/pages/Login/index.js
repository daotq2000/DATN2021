                    ...
                    <div className="form-login">
                      {/* <form method="post" action="https://vip321.mysapo.vn/admin/authorization/login?returnurl=%2Fadmin%2Fdashboard%3Ftype%3D4"> */}
                        <div className="login-logo text-center">
                          <img src="https://vip321.mysapo.vn/v2/images/logo_sapo.svg" alt="sapo" />
                        </div>
                      ...
                      <div className="social-login text-center">
                        <span className="social-login__label">Hoặc đăng nhập với</span>
                        <div className="social-login__btn-group">
                          <a className="social-login__item social-login--facebook" >
                            <img src="https://vip321.mysapo.vn/v2/images/facebook-8-1-2020.svg" alt="sapo" />
                          </a>
                          <a className="social-login__item social-login--google">
                            <img src="https://vip321.mysapo.vn/v2/images/google-8-1-2020.svg" alt="sapo" />
                          </a>
                        </div>
                      </div>
                      <div>
