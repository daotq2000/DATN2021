                                        ...
                                        <div>
                                            ...
                                            <div style={{ width: 500, display: 'flex', justifyContent: 'space-between' }}>
                                                <div>
                                                    ...
                                                    <Select style={{ width: 200, marginLeft: 30 }}  defaultValue={'Thanh toán trực tiếp'}>
                                                        <Option value="1">
                                                            <span>Thanh toán trực tiếp</span>
                                                        </Option>
                                                        <Option value="2"> <span>Thanh toán qua thẻ</span></Option>
                                                    </Select>
                                                </div>

                                                <Input style={{ width: 150 }} type='number' addonAfter='đ' />
                                            </div>
                                            <div>
